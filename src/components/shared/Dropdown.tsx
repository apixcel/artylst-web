    ...
    <div ref={rootRef} className={cn("relative inline-block", className)}>
      ...
      {open && (
        <div
          ...
          className={cn(
            "absolute z-10 mt-2 max-h-56 overflow-auto rounded-[8px] p-2 text-light shadow-lg focus:outline-none bg-gray-70 border border-white/10",
            matchButtonWidth && "min-w-[var(--btn-w)]",
            panelClassName
          )}
          style={{
            ...
            {options.map((opt, i) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center justify-between gap-2 rounded-[8px] px-3 py-1 text-left text-sm hover:bg-gray-55 focus:bg-gray-55 focus:outline-none",
                    isSelected && "bg-gray-55",
