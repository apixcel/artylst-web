  ...
  return (
    <section className="mb-[64px]">
      <div className="flex justify-between items-center mb-[20px]">
        <h2 className="mb-[20px]">Top 10 on Artylst</h2>
      ...
      >
        {top10.map((item, index) => (
          <SwiperSlide
            key={item.id}
            className="rounded-[24px] flex flex-col justify-center overflow-hidden bg-transparent"
          >
            <Link
              className="bg-transparent relative aspect-[21/37 relative rounded-[16px] overflow-hidden flex flex-col shrink-0"
              href={`/${item.username}`}
            >
              {/* header */}
              <div className="flex justify-between absolute top-0 left-0 w-full ">
                {/* crown */}
                <div className="flex gap-[4px] backdrop-blur-xs bg-white-transparent-80 rounded-br-[16px] py-[4px] px-[12px] rounded-tl-[24px]">
                  ...
                  <p className="text-black font-bold text-[20px]">{index + 1}</p>
                ...
                {/* icon */}
                <div className="w-[24px] h-[24px] rounded-full bg-black-transparent-70 text-mario-coin flex-center mr-[8px] mt-[8px]">
              ...
              <div className="h-1/2">
                <div className="absolute top-[10px] bottom-0 -left-[100px] right-0  w-[160px] h-[150px] blur-[32px] bg-muted"></div>
                <div className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-full w-full h-full blur-[32px] bg-muted"></div>

                <div className="absolute top-[10px] bottom-0 -right-[100px] w-[160px] h-[150px] blur-[32px] bg-muted"></div>
              </div>

              <div>
                <div className="flex flex-col gap-[4px] text-center">
                  <p className="text-[18px] font-bold font-bricolage-grotesque leading-[0.85] uppercase">
                    {item.name}
                  </p>
                  <p className="">{item.designation}</p>
                </div>

                <div className="flex justify-between py-[16px] px-[20px] bg-black-transparent-40">
