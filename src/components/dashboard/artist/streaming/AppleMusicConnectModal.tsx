...
const AppleMusicConnectModal: React.FC<{
  open: boolean;
    ...
    >
      ...
      >
        <div className="space-y-1">
          <h3 className="text-lg font-semibold">Connect Apple Music</h3>
          <p className="text-sm text-muted">
            Paste your Apple Music profile or playlist owner name.
          </p>
        </div>

        <label className="block text-sm">
          <span className="text-muted">Apple Music ID</span>
          <input
            autoFocus
            value={value}
...
export default AppleMusicConnectModal;
