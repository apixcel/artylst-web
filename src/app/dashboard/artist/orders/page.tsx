  ...
  return (
    <section className="p-6 space-y-6">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-heading">Orders</h1>
          <p className="text-white/60 text-sm mt-1">Accept, work, deliver</p>
        </div>
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            <tr className="border-b border-white/5">
              ...
              <td className="py-3 pr-6">Arif</td>
              <td className="py-3 pr-6">Standard</td>
              <td className="py-3 pr-6">Spotify</td>
              <td className="py-3 pr-6">
                <span className="chip">In progress</span>
              </td>
              <td className="py-3">
                <a className="px-2 py-1 rounded bg-white/10 text-xs" href="deliver.html">
                  Open
                </a>
              </td>
            </tr>
            <tr>
              ...
              <td className="py-3 pr-6">Nadia</td>
              <td className="py-3 pr-6">Mini</td>
              <td className="py-3 pr-6">Apple</td>
              <td className="py-3 pr-6">
