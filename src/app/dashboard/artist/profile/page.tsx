    ...
    <section className="p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="md:col-span-2 rounded-2xl p-6 border border-white/10 bg-white/5 space-y-4">
          ...
          <div>
            <label className="text-sm text-white/60">Genres &amp; tags</label>
            <input
              className="w-full mt-1 bg-white/10 border border-white/10 rounded-lg px-3 py-2"
              placeholder="Hip‑hop, R&amp;B, soulful, clean"
            />
          </div>
          <div className="grid sm:grid-cols-3 gap-4">
            <div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <label className="text-sm text-white/60">Intro video URL</label>
              <input
                className="w-full mt-1 bg-white/10 border border-white/10 rounded-lg px-3 py-2"
            ...
            <div>
              <label className="text-sm text-white/60">Sample playlist URL</label>
              <input
                className="w-full mt-1 bg-white/10 border border-white/10 rounded-lg px-3 py-2"
