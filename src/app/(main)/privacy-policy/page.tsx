  ...
  return (
    <div className="wrapper max-w-3xl" id="top">
      <section className="py-16 text-white">
        ...
        {/* Effective Date */}
        <p className="italic text-gray-300 mb-10">
      ...
      <section id="cookies" className="py-12 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-6">3. Cookies and Tracking Technologies</h2>
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p>
      ...
      <section id="use" className="py-12 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-6">4. How We Use Information</h2>
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p>
      ...
      <section id="share" className="py-12 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-6">5. How We Share Information</h2>
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p>
      ...
      <section id="children" className="py-12 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-6">6. Children and Parents</h2>
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p>
      ...
      <section id="choices" className="py-12 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-6">7. Your Choices</h2>
        <div className="space-y-6 text-gray-200 leading-relaxed">
