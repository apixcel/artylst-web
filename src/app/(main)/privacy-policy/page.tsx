  ...
  return (
    <div className="wrapper-inner" id="top">
      <section className="py-16 text-white">
        ...
        {/* Intro */}
        <p className=" mx-auto text-gray-200 text-[14px] font-[400] leading-[20px] mb-[20px] font-logam">
      ...
      <section id="scope" className="py-12 border-t border-white/10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed font-logam">
      ...
      <section id="information" className="py-12 border-t border-white/10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p className="text-[14px] font-[400] leading-[20px] font-logam">
      ...
      <section id="cookies" className="py-12 border-t border-white/10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          ...
          <ul className="list-disc list-inside space-y-2 font-logam">
            <li>
