    ...
    <div>
      <section className="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-3xl md:text-5xl font-heading leading-tight">
            Meet the team curating the curators.
          </h1>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="chip">Music-first</span>
      ...
      <section id="advisors" className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="card p-4">
            <div className="h-28 rounded-xl bg-white/5 border border-white/10 grid place-items-center text-white/60">
              PHOTO
            </div>
