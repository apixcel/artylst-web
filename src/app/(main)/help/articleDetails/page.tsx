    ...
    <div className=" wrapper-innerbg-white/5 border border-white/10 rounded-lg shadow max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3">
      ...
      <div className="col-span-2 p-6 ">
        ...
        <p className=" mb-4">
          ...
          your Artylst video. Next, tap on your Artylst video, and click on the three dots
          at the bottom right corner of the screen. From there, you should see the option
