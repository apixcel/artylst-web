...
import { ArtistWithdrawAmount, Dropdown, UnauthorizedMsgBox } from "@/components";
import { DropdownOption } from "@/interface";
import { useAppSelector } from "@/hooks";

const ArtistEarningsView = () => {
      ...
      <div className="rounded-2xl p-2 sm:p-6 border border-white/10 bg-gradient-to-b from-brand-2/10 to-brand-1/10 backdrop-blur-2xl">
        <div className="flex sm:flex-row flex-col sm:gap-0 gap-4 items-center justify-between mb-4">
          ...
          <Dropdown
            ...
            className=""
            panelClassName="backdrop-blur-2xl"
          />
        </div>
        <div className="h-64">
...
export default ArtistEarningsView;
